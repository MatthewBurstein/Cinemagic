...
public class BookingTest extends IntegrationTestBase {
    ...
    public void mainlineBookingFlow() {
        ...
        filmSelectionPage.waitForPageLoad();
        filmSelectionPage.selectFilm(filmName, formattedFilmTime);
        ...
        seatSelectionPage.waitForPageLoad();
        assertThat(seatSelectionPage.getSeatStatus(0,0), equalTo("X"));
        assertThat(seatSelectionPage.getSeatStatus(2,3), equalTo("X"));
    }
