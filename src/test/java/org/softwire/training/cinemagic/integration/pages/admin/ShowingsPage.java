...
public class ShowingsPage extends AbstractNavigablePage {
    ...
    public void waitForPageLoad() {
        support.waitForElement(By.id("showings"));
    }
    ...
    public void selectScreen(String cinemaName, String screenName) {
        driver.findElement(By.id("showings-screen-selector"))
                ...
                .get()
                .click();
        support.waitForElement(By.id("showings-details"));
    }
    ...
    public void createShowing(String filmName, String date, String time) {
        ...
        driver.findElement(By.id("showing-form-time-field")).sendKeys(Keys.RETURN);
